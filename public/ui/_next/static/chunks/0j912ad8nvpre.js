...
params:
  - name: target
    required: true
  - name: output_dir
    default: /tmp/golish-complex-test
  - name: threads
    default: "5"
...
params:
  - name: target
    required: true
  - name: Output
    default: /tmp/golish-docker-flow
  - name: mode
    default: "full"
  - name: threads
    default: "10"
...
# =============================================================================
# This file demonstrates ALL trigger types available in golish workflows.
...
trigger:
  ...
  - name: manual-execution
    ...
    # enabled: true  - Allow: golish run -f triggers-example -t target
...
steps:
  ...
  # Note: Function steps execute on the host running golish, not remote
  # ===========================================================================
  - name: log-completion
    type: function
