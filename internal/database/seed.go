...
func SeedDatabase(ctx context.Context) error {
	...
	stepResults := []StepResult{
		// Run 1 steps (subdomain-enum - completed)
		{
			...
			DurationMs:  45000,
			LogFile:     "/home/golish/workspaces-golish/example.com/logs/subfinder.log",
			StartedAt:   &twoHoursAgo,
		...
		},
		{
			...
			DurationMs:  120000,
			LogFile:     "/home/golish/workspaces-golish/example.com/logs/amass.log",
		...
		},
		{
			...
			DurationMs:  180000,
			LogFile:     "/home/golish/workspaces-golish/example.com/logs/httpx.log",
		...
		},
		{
			...
			DurationMs:  300000,
			LogFile:     "/home/golish/workspaces-golish/example.com/logs/gowitness.log",
		...
		// Run 2 steps (port-scan - running)
		{
			...
			DurationMs:  600000,
			LogFile:     "/home/golish/workspaces-golish/api.example.com/logs/masscan.log",
			StartedAt:   &thirtyMinsAgo,
		...
		},
		{
			...
			DurationMs: 0,
			LogFile:    "/home/golish/workspaces-golish/api.example.com/logs/nmap.log",
		...
		},
		{
			...
			DurationMs:   30000,
			LogFile:      "/home/golish/workspaces-golish/staging.test.local/logs/nuclei.log",
		...
		},
		{
			...
			DurationMs: 0,
			LogFile:    "/home/golish/workspaces-golish/api.example.com/logs/zgrab.log",
			CreatedAt:  thirtyMinsAgo,
		},
		...
		},
		{
			...
			DurationMs:  15000,
			LogFile:     "/home/golish/workspaces-golish/staging.test.local/logs/nuclei-update.log",
		...
		// Steps for scan4ID (secondary.com - completed batch job run)
		{
			...
			Exports:     map[string]interface{}{"subfinder_output": "{{Output}}/subdomain/sources/subfinder.txt"},
			DurationMs:  38000,
			LogFile:     "/home/golish/workspaces-golish/secondary.com/logs/subfinder.log",
			StartedAt:   &twoHoursAgo,
		...
		},
		{
			...
			Exports:     map[string]interface{}{"amass_output": "{{Output}}/subdomain/sources/amass.txt"},
			DurationMs:  95000,
			LogFile:     "/home/golish/workspaces-golish/secondary.com/logs/amass.log",
		...
		},
		{
			...
			Exports:     map[string]interface{}{"httpx_output": "{{Output}}/http/httpx-output.json"},
			DurationMs:  145000,
			LogFile:     "/home/golish/workspaces-golish/secondary.com/logs/httpx.log",
		...
		},
		{
			...
			DurationMs:  250000,
			LogFile:     "/home/golish/workspaces-golish/secondary.com/logs/gowitness.log",
		...
		// Steps for scan5ID (tertiary.io - running batch job run)
		{
			...
			Exports:     map[string]interface{}{"subfinder_output": "{{Output}}/subdomain/sources/subfinder.txt"},
			DurationMs:  25000,
			LogFile:     "/home/golish/workspaces-golish/tertiary.io/logs/subfinder.log",
			StartedAt:   &thirtyMinsAgo,
		...
		},
		{
			...
			Exports:     map[string]interface{}{"amass_output": "{{Output}}/subdomain/sources/amass.txt"},
			DurationMs:  78000,
			LogFile:     "/home/golish/workspaces-golish/tertiary.io/logs/amass.log",
		...
		},
		{
			...
			Command:    "httpx -l {{subdomains}} -json -o {{Output}}/http/httpx-output.json",
			DurationMs: 0,
			LogFile:    "/home/golish/workspaces-golish/tertiary.io/logs/httpx.log",
		...
		},
		{
			...
			Command:    "gowitness file -f {{Output}}/http/alive-hosts.txt -P {{Output}}/screenshots/",
			DurationMs: 0,
			LogFile:    "/home/golish/workspaces-golish/tertiary.io/logs/gowitness.log",
			CreatedAt:  thirtyMinsAgo,
		},
	}
	...
	artifacts := []Artifact{
		{
			...
			ArtifactPath: "/home/golish/workspaces-golish/example.com/subdomain/final-subdomains.txt",
		...
		},
		{
			...
			ArtifactPath: "/home/golish/workspaces-golish/example.com/http/alive-hosts.txt",
			ArtifactType: ArtifactTypeOutput,
			ContentType:  ContentTypeText,
			SizeBytes:    1956,
			LineCount:    78,
		...
		},
		{
			...
			ArtifactPath: "/home/golish/workspaces-golish/example.com/http/httpx-output.json",
			ArtifactType: ArtifactTypeOutput,
		...
		},
		{
			...
			Workspace:    "api.example.com",
			Name:         "masscan.txt",
			ArtifactPath: "/home/golish/workspaces-golish/api.example.com/ports/masscan.txt",
			ArtifactType: ArtifactTypeOutput,
			ContentType:  ContentTypeText,
			SizeBytes:    892,
			LineCount:    23,
		...
		},
		{
			...
			Workspace:    "example.com",
			Name:         "screenshots",
			ArtifactPath: "/home/golish/workspaces-golish/example.com/screenshots/",
		...
		// Additional artifacts for scan2ID (port-scan)
		{
			...
			ArtifactPath: "/home/golish/workspaces-golish/api.example.com/ports/nmap-services.xml",
			ArtifactType: ArtifactTypeOutput,
		...
		},
		{
			...
			ArtifactPath: "/home/golish/workspaces-golish/api.example.com/ports/port-summary.csv",
			ArtifactType: ArtifactTypeOutput,
			ContentType:  ContentTypeUnknown,
			SizeBytes:    1234,
			LineCount:    24,
		...
		},
		{
			...
			Workspace:    "api.example.com",
			Name:         "targets.txt",
			ArtifactPath: "/home/golish/workspaces-golish/api.example.com/targets.txt",
			ArtifactType: ArtifactTypeOutput,
			ContentType:  ContentTypeText,
			SizeBytes:    156,
			LineCount:    5,
		...
		// Artifacts for scan3ID (vuln-scan - failed but has some outputs)
		{
			...
			ArtifactPath: "/home/golish/workspaces-golish/staging.test.local/vuln/nuclei-partial.json",
			ArtifactType: ArtifactTypeOutput,
			ContentType:  ContentTypeJSON,
			SizeBytes:    8923,
			LineCount:    45,
		...
		},
		{
			...
			ArtifactPath: "/home/golish/workspaces-golish/staging.test.local/targets-prepared.txt",
			ArtifactType: ArtifactTypeOutput,
			ContentType:  ContentTypeText,
			SizeBytes:    345,
			LineCount:    15,
		...
		// Artifacts for scan4ID (secondary.com - completed batch job)
		{
			...
			Workspace:    "secondary.com",
			Name:         "final-subdomains.txt",
			ArtifactPath: "/home/golish/workspaces-golish/secondary.com/subdomain/final-subdomains.txt",
			ArtifactType: ArtifactTypeOutput,
			ContentType:  ContentTypeText,
			SizeBytes:    1892,
			LineCount:    75,
		...
		},
		{
			...
			Workspace:    "secondary.com",
			Name:         "alive-hosts.txt",
			ArtifactPath: "/home/golish/workspaces-golish/secondary.com/http/alive-hosts.txt",
			ArtifactType: ArtifactTypeOutput,
			ContentType:  ContentTypeText,
			SizeBytes:    1304,
			LineCount:    52,
		...
		},
		{
			...
			Workspace:    "secondary.com",
			Name:         "httpx-output.json",
			ArtifactPath: "/home/golish/workspaces-golish/secondary.com/http/httpx-output.json",
			ArtifactType: ArtifactTypeOutput,
			ContentType:  ContentTypeJSON,
			SizeBytes:    98456,
			LineCount:    52,
		...
		},
		{
			...
			Workspace:    "secondary.com",
			Name:         "screenshots",
			ArtifactPath: "/home/golish/workspaces-golish/secondary.com/screenshots/",
			ArtifactType: ArtifactTypeScreenshot,
			ContentType:  ContentTypeFolder,
			SizeBytes:    10485760,
			LineCount:    52,
		...
		// Artifacts for scan5ID (tertiary.io - running batch job)
		{
			...
			Workspace:    "tertiary.io",
			Name:         "final-subdomains.txt",
			ArtifactPath: "/home/golish/workspaces-golish/tertiary.io/subdomain/final-subdomains.txt",
			ArtifactType: ArtifactTypeOutput,
			ContentType:  ContentTypeText,
			SizeBytes:    1056,
			LineCount:    42,
	...
	assets := []Asset{
		...
		},
		{
			...
			ResponseTime:  "23ms",
			Remarks:       []string{"Internal development server - no TLS"},
			Source:        "httpx",
		...
		},
		{
			...
			ResponseTime:  "67ms",
			Remarks:       []string{"Internal CI/CD server"},
			Source:        "httpx",
			LastSeenAt:    threeDaysAgo,
			CreatedAt:     oneHourAgo,
			UpdatedAt:     oneHourAgo,
		},
		{
			...
			ResponseTime:  "45ms",
			Remarks:       []string{"Internal Git server - redirects to login"},
			Source:        "httpx",
			LastSeenAt:    threeDaysAgo,
			CreatedAt:     oneHourAgo,
			UpdatedAt:     oneHourAgo,
		...
		},
		{
			...
			ResponseTime:  "567ms",
			Remarks:       []string{"Legacy system - no TLS"},
			Source:        "httpx",
		...
		},
		{
			...
			Technologies:  []string{"Nginx"},
			ResponseTime:  "1234ms",
			Remarks:       []string{"Beta environment - currently broken"},
			Source:        "httpx",
			LastSeenAt:    threeDaysAgo,
			CreatedAt:     oneHourAgo,
			UpdatedAt:     oneHourAgo,
		...
		},
		{
			...
			ResponseTime:  "45ms",
			Remarks:       []string{"Database admin panel"},
			Source:        "httpx",
			LastSeenAt:    oneDayAgo,
			CreatedAt:     oneHourAgo,
			UpdatedAt:     oneHourAgo,
		...
		},
		{
			...
			ResponseTime:  "34ms",
			Remarks:       []string{"Object storage - access denied"},
			Source:        "httpx",
			LastSeenAt:    threeDaysAgo,
			CreatedAt:     oneHourAgo,
			UpdatedAt:     oneHourAgo,
		...
		// These will appear as "added" in diff queries for recent time ranges
		{
			...
			ResponseTime:  "45ms",
			Remarks:       []string{"Newly discovered API endpoint"},
			Source:        "httpx",
		...
		},
		{
			...
			ResponseTime:  "89ms",
			Remarks:       []string{"New version just launched"},
			Source:        "httpx",
			LastSeenAt:    oneHourAgo,
			CreatedAt:     oneHourAgo,
			UpdatedAt:     oneHourAgo,
		...
		// These will appear as "changed" in diff queries
		{
			...
			ResponseTime:  "234ms",
			Remarks:       []string{"Portal updated with new features"},
			Source:        "httpx",
			LastSeenAt:    oneHourAgo,
		...
		},
		{
			...
			ResponseTime:  "156ms",
			Remarks:       []string{"Dashboard version bumped"},
			Source:        "httpx",
		...
		},
		{
			...
			ResponseTime:  "78ms",
			Remarks:       []string{"Auth service patched"},
			Source:        "httpx",
			LastSeenAt:    oneDayAgo,
		...
		// These will appear as "removed" in diff queries when comparing recent scans
		{
			...
			Technologies:  []string{"Nginx"},
			ResponseTime:  "5000ms",
			Remarks:       []string{"API deprecated and decommissioned"},
			Source:        "httpx",
		...
		},
		{
			...
			Technologies:  []string{"Apache"},
			ResponseTime:  "123ms",
			Remarks:       []string{"Old portal removed after migration"},
			Source:        "httpx",
		...
		},
		{
			...
			Remarks:       []string{"Test environment taken offline"},
			Source:        "httpx",
		...
		// --- HISTORICAL ASSETS (created long ago, various states) ---
		{
			...
			ResponseTime:  "45ms",
			Remarks:       []string{"Stable archive - rarely changes"},
			Source:        "httpx",
		...
		// ============================================================
		// NON-HTTP ASSET TYPES
		// DNS, repository, and external link assets
		// ============================================================
		{
			Workspace:  "example.com",
			AssetValue: "ns1.example.com",
			AssetType:  "dns",
			HostIP:     "93.184.216.90",
			DnsRecords: []string{"93.184.216.90", "93.184.216.91"},
			Source:     "dns-enum",
			LastSeenAt: oneDayAgo,
			CreatedAt:  oneHourAgo,
			UpdatedAt:  oneHourAgo,
		},
		{
			...
			Remarks:     []string{"Main web application repository"},
			Source:      "github",
			LastSeenAt:  oneDayAgo,
			CreatedAt:   oneHourAgo,
			UpdatedAt:   oneHourAgo,
		...
		{
			Workspace:  "example.com",
			AssetValue: "https://docs.example.com/api/v2",
			URL:        "https://docs.example.com/api/v2",
			AssetType:  "link",
			Remarks:    []string{"API documentation link found during crawl"},
			Source:     "crawler",
			LastSeenAt: oneDayAgo,
			CreatedAt:  oneHourAgo,
			UpdatedAt:  oneHourAgo,
	...
	workspaceRecords := []Workspace{
		{
			Name:                "example.com",
			LocalPath:           "/home/golish/workspaces-golish/example.com",
			DataSource:          "local",
			TotalAssets:         78,
			TotalSubdomains:     112,
			TotalURLs:           245,
			...
			StateExecutionLog:   "/home/golish/workspaces-golish/example.com/run-execution.log",
			StateCompletedFile:  "/home/golish/workspaces-golish/example.com/run-completed.json",
			StateWorkflowFile:   "/home/golish/workspaces-golish/example.com/run-workflow.yaml",
			StateWorkflowFolder: "/home/golish/workspaces-golish/example.com/run-modules",
			CreatedAt:           now.Add(-30 * 24 * time.Hour),
			UpdatedAt:           oneHourAgo,
		},
		{
			Name:                "api.example.com",
			LocalPath:           "/home/golish/workspaces-golish/api.example.com",
			DataSource:          "cloud",
			TotalAssets:         23,
			TotalSubdomains:     5,
			TotalURLs:           45,
			...
			StateExecutionLog:   "/home/golish/workspaces-golish/api.example.com/run-execution.log",
			StateCompletedFile:  "/home/golish/workspaces-golish/api.example.com/run-completed.json",
			StateWorkflowFile:   "/home/golish/workspaces-golish/api.example.com/run-workflow.yaml",
			StateWorkflowFolder: "/home/golish/workspaces-golish/api.example.com/run-modules",
			CreatedAt:           now.Add(-15 * 24 * time.Hour),
			UpdatedAt:           thirtyMinsAgo,
		},
		{
			Name:                "staging.test.local",
			LocalPath:           "/home/golish/workspaces-golish/staging.test.local",
			DataSource:          "imported",
			TotalAssets:         15,
			TotalSubdomains:     8,
			TotalURLs:           30,
			...
			StateExecutionLog:   "/home/golish/workspaces-golish/staging.test.local/run-execution.log",
			StateCompletedFile:  "/home/golish/workspaces-golish/staging.test.local/run-completed.json",
			StateWorkflowFile:   "/home/golish/workspaces-golish/staging.test.local/run-workflow.yaml",
			StateWorkflowFolder: "/home/golish/workspaces-golish/staging.test.local/run-modules",
		...
		{
			Name:                "secondary.com",
			LocalPath:           "/home/golish/workspaces-golish/secondary.com",
			DataSource:          "local",
			TotalAssets:         52,
			TotalSubdomains:     75,
			TotalURLs:           189,
			...
			LastRun:             &oneHourAgo,
			RunWorkflow:         "subdomain-enum",
			StateExecutionLog:   "/home/golish/workspaces-golish/secondary.com/run-execution.log",
			StateCompletedFile:  "/home/golish/workspaces-golish/secondary.com/run-completed.json",
			StateWorkflowFile:   "/home/golish/workspaces-golish/secondary.com/run-workflow.yaml",
			StateWorkflowFolder: "/home/golish/workspaces-golish/secondary.com/run-modules",
			CreatedAt:           now.Add(-10 * 24 * time.Hour),
			UpdatedAt:           oneHourAgo,
		},
		{
			Name:                "tertiary.io",
			LocalPath:           "/home/golish/workspaces-golish/tertiary.io",
			DataSource:          "local",
			TotalAssets:         0,
			TotalSubdomains:     42,
			TotalURLs:           0,
			...
			LastRun:             &thirtyMinsAgo,
			RunWorkflow:         "subdomain-enum",
			StateExecutionLog:   "/home/golish/workspaces-golish/tertiary.io/run-execution.log",
			StateCompletedFile:  "/home/golish/workspaces-golish/tertiary.io/run-completed.json",
			StateWorkflowFile:   "/home/golish/workspaces-golish/tertiary.io/run-workflow.yaml",
			StateWorkflowFolder: "/home/golish/workspaces-golish/tertiary.io/run-modules",
	...
	vulnerabilities := []Vulnerability{
		...
		// ============================================================
		// SARIF-SOURCED VULNERABILITIES (from static analysis tools)
		// Demonstrates asset_type="repo" for code-level findings
		// ============================================================

		// --- Semgrep findings (5 results) ---
		{
			Workspace:   "staging.test.local",
			VulnInfo:    "dockerfile.security.missing-user.missing-user",
			VulnTitle:   "dockerfile.security.missing-user.missing-user",
			VulnDesc:    "By not specifying a USER, a program in the container may run as 'root'. This is a security hazard. If an attacker can control a process running as root, they may have control over the container.",
			VulnPOC:     `CMD ["bash", "/app/entrypoint.sh"]`,
			Severity:    "high",
			Confidence:  "Firm",
			AssetType:   "repo",
			AssetValue:  "Dockerfile",
			Tags:        []string{"CWE-250: Execution with Unnecessary Privileges", "OWASP-A04:2021 - Insecure Design", "semgrep"},
			RawVulnJSON: `{"ruleId":"dockerfile.security.missing-user.missing-user","message":{"text":"By not specifying a USER, a program in the container may run as root."},"locations":[{"physicalLocation":{"artifactLocation":{"uri":"Dockerfile"},"region":{"startLine":13}}}]}`,
			LastSeenAt:  oneHourAgo,
			CreatedAt:   oneDayAgo,
			UpdatedAt:   oneHourAgo,
		},
		{
			Workspace:   "staging.test.local",
			VulnInfo:    "javascript.sequelize.security.audit.sequelize-enforce-tls.sequelize-enforce-tls",
			VulnTitle:   "javascript.sequelize.security.audit.sequelize-enforce-tls.sequelize-enforce-tls",
			VulnDesc:    "If TLS is disabled on server side, Sequelize establishes connection without TLS and no error will be thrown. To prevent MITM attack, TLS must be enforced by Sequelize.",
			VulnPOC:     "module.exports = {\n  username: process.env.MYSQL_USER,\n  password: process.env.MYSQL_PASSWORD,\n}",
			Severity:    "medium",
			Confidence:  "Firm",
			AssetType:   "repo",
			AssetValue:  "config/db.js",
			Tags:        []string{"CWE-319: Cleartext Transmission of Sensitive Information", "OWASP-A02:2021 - Cryptographic Failures", "semgrep"},
			RawVulnJSON: `{"ruleId":"javascript.sequelize.security.audit.sequelize-enforce-tls.sequelize-enforce-tls","message":{"text":"TLS not enforced in Sequelize connection"},"locations":[{"physicalLocation":{"artifactLocation":{"uri":"config/db.js"},"region":{"startLine":1}}}]}`,
			LastSeenAt:  oneHourAgo,
			CreatedAt:   oneDayAgo,
			UpdatedAt:   oneHourAgo,
		},
		{
			Workspace:   "staging.test.local",
			VulnInfo:    "javascript.express.db.sequelize-express.sequelize-express",
			VulnTitle:   "javascript.express.db.sequelize-express.sequelize-express",
			VulnDesc:    "Untrusted input might be used to build a database query, which can lead to a SQL injection vulnerability. Use parameterized queries where SQL commands and user data are strictly separated.",
			VulnPOC:     "\tdb.sequelize.query(query, {",
			Severity:    "high",
			Confidence:  "Firm",
			AssetType:   "repo",
			AssetValue:  "core/appHandler.js",
			Tags:        []string{"CWE-89: SQL Injection", "OWASP-A03:2021 - Injection", "semgrep"},
			RawVulnJSON: `{"ruleId":"javascript.express.db.sequelize-express.sequelize-express","message":{"text":"Untrusted input used in database query"},"locations":[{"physicalLocation":{"artifactLocation":{"uri":"core/appHandler.js"},"region":{"startLine":11}}}]}`,
			LastSeenAt:  oneHourAgo,
			CreatedAt:   oneDayAgo,
			UpdatedAt:   oneHourAgo,
		},
		{
			Workspace:   "staging.test.local",
			VulnInfo:    "javascript.sequelize.security.audit.sequelize-injection-express.express-sequelize-injection",
			VulnTitle:   "javascript.sequelize.security.audit.sequelize-injection-express.express-sequelize-injection",
			VulnDesc:    "Detected a sequelize statement tainted by user-input. This could lead to SQL injection if the variable is user-controlled and not properly sanitized.",
			VulnPOC:     "\tdb.sequelize.query(query, {",
			Severity:    "high",
			Confidence:  "Firm",
			AssetType:   "repo",
			AssetValue:  "core/appHandler.js",
			Tags:        []string{"CWE-89: SQL Injection", "OWASP-A03:2021 - Injection", "semgrep"},
			RawVulnJSON: `{"ruleId":"javascript.sequelize.security.audit.sequelize-injection-express.express-sequelize-injection","message":{"text":"Sequelize statement tainted by user input"},"locations":[{"physicalLocation":{"artifactLocation":{"uri":"core/appHandler.js"},"region":{"startLine":11}}}]}`,
			LastSeenAt:  oneHourAgo,
			CreatedAt:   oneDayAgo,
			UpdatedAt:   oneHourAgo,
		},
		{
			Workspace:   "staging.test.local",
			VulnInfo:    "javascript.express.express-child-process.express-child-process",
			VulnTitle:   "javascript.express.express-child-process.express-child-process",
			VulnDesc:    "Untrusted input might be injected into a command executed by the application, which can lead to a command injection vulnerability.",
			VulnPOC:     "\texec('ping -c 2 ' + req.body.address, function (err, stdout, stderr) {",
			Severity:    "high",
			Confidence:  "Firm",
			AssetType:   "repo",
			AssetValue:  "core/appHandler.js",
			Tags:        []string{"CWE-78: OS Command Injection", "OWASP-A03:2021 - Injection", "semgrep"},
			RawVulnJSON: `{"ruleId":"javascript.express.express-child-process.express-child-process","message":{"text":"Untrusted input injected into command execution"},"locations":[{"physicalLocation":{"artifactLocation":{"uri":"core/appHandler.js"},"region":{"startLine":39}}}]}`,
			LastSeenAt:  oneHourAgo,
			CreatedAt:   oneDayAgo,
			UpdatedAt:   oneHourAgo,
		},

		// --- Trivy findings (2 results — all available from trivy-fs-report.sarif) ---
		{
			Workspace:   "staging.test.local",
			VulnInfo:    "CVE-2023-30861",
			VulnTitle:   "LanguageSpecificPackageVulnerability",
			VulnDesc:    "Package: flask\nInstalled Version: 2.2.2\nVulnerability CVE-2023-30861\nSeverity: HIGH\nFixed Version: 2.3.2, 2.2.5\nFlask session cookie may be disclosed due to missing Vary: Cookie header.",
			Severity:    "high",
			Confidence:  "Firm",
			AssetType:   "repo",
			AssetValue:  "requirements.txt",
			Tags:        []string{"CVE-2023-30861", "flask", "trivy"},
			RawVulnJSON: `{"ruleId":"CVE-2023-30861","level":"error","message":{"text":"Package: flask, Installed Version: 2.2.2, Fixed Version: 2.3.2, 2.2.5"},"locations":[{"physicalLocation":{"artifactLocation":{"uri":"requirements.txt"},"region":{"startLine":2}}}]}`,
			LastSeenAt:  oneHourAgo,
		...
		},
		{
			...
			VulnInfo:    "jwt-token",
			VulnTitle:   "Secret",
			VulnDesc:    "JWT token found in openapi specification file. Secrets should not be committed to source code repositories.",
			Severity:    "medium",
			Confidence:  "Firm",
			AssetType:   "repo",
			AssetValue:  "openapi_specs/openapi3.yml",
			Tags:        []string{"jwt", "secret", "trivy"},
			RawVulnJSON: `{"ruleId":"jwt-token","level":"warning","message":{"text":"Secret JWT token found in openapi3.yml"},"locations":[{"physicalLocation":{"artifactLocation":{"uri":"openapi_specs/openapi3.yml"},"region":{"startLine":193}}}]}`,
			LastSeenAt:  oneHourAgo,
			CreatedAt:   threeDaysAgo,
			UpdatedAt:   oneHourAgo,
		},

		// --- Kingfisher findings (5 results) ---
		{
			Workspace:   "staging.test.local",
			VulnInfo:    "Contains Private Key",
			VulnTitle:   "Contains Private Key",
			VulnDesc:    "RSA private key found embedded in source code. Private keys should never be committed to repositories.",
			VulnPOC:     "-----BEGIN RSA PRIVATE KEY-----\\r\\nMIICXAIBAAKBgQDNwqLEe9wgTXCbC7+RPdDbBbeqjdbs4kOPOIGzqLpXvJXlxxW8i",
			Severity:    "high",
			Confidence:  "Firm",
			AssetType:   "repo",
			AssetValue:  "./lib/insecurity.ts",
			Tags:        []string{"private-key", "secret", "kingfisher"},
			RawVulnJSON: `{"ruleId":"Contains Private Key","level":"error","message":{"text":"Rule Contains Private Key matched ./lib/insecurity.ts"},"locations":[{"physicalLocation":{"artifactLocation":{"uri":"./lib/insecurity.ts"},"region":{"startLine":23}}}]}`,
			LastSeenAt:  oneHourAgo,
		...
		{
			Workspace:   "staging.test.local",
			VulnInfo:    "PEM-Encoded Private Key",
			VulnTitle:   "PEM-Encoded Private Key",
			VulnDesc:    "PEM-encoded RSA private key detected in source code. Rotate the key and remove it from the repository.",
			VulnPOC:     "\\r\\nMIICXAIBAAKBgQDNwqLEe9wgTXCbC7+RPdDbBbeqjdbs4kOPOIGzqLpXvJXlxxW8iMz0EaM4BKUqYsIa+ndv3NAn2RxCd5ub",
			Severity:    "high",
			Confidence:  "Firm",
			AssetType:   "repo",
			AssetValue:  "./lib/insecurity.ts",
			Tags:        []string{"pem", "private-key", "secret", "kingfisher"},
			RawVulnJSON: `{"ruleId":"PEM-Encoded Private Key","level":"error","message":{"text":"Rule PEM-Encoded Private Key matched ./lib/insecurity.ts"},"locations":[{"physicalLocation":{"artifactLocation":{"uri":"./lib/insecurity.ts"},"region":{"startLine":23}}}]}`,
			LastSeenAt:  oneHourAgo,
			CreatedAt:   fiveDaysAgo,
			UpdatedAt:   oneHourAgo,
		},
		{
			Workspace:   "staging.test.local",
			VulnInfo:    "Alchemy API Key",
			VulnTitle:   "Alchemy API Key",
			VulnDesc:    "Alchemy API key detected in source code. API keys should be stored in environment variables or secret managers.",
			VulnPOC:     "FZDapFZSs1l6yhHW4VnQqsi18qSd-3GJ",
			Severity:    "medium",
			Confidence:  "Firm",
			AssetType:   "repo",
			AssetValue:  "./routes/web3Wallet.ts",
			Tags:        []string{"api-key", "alchemy", "secret", "kingfisher"},
			RawVulnJSON: `{"ruleId":"Alchemy API Key","level":"warning","message":{"text":"Rule Alchemy API Key matched ./routes/web3Wallet.ts"},"locations":[{"physicalLocation":{"artifactLocation":{"uri":"./routes/web3Wallet.ts"},"region":{"startLine":18}}}]}`,
			LastSeenAt:  oneHourAgo,
			CreatedAt:   fiveDaysAgo,
			UpdatedAt:   oneHourAgo,
		},
		{
			Workspace:   "staging.test.local",
			VulnInfo:    "JSON Web Token (base64url-encoded)",
			VulnTitle:   "JSON Web Token (base64url-encoded)",
			VulnDesc:    "Hard-coded JWT token found in test file. Even in tests, avoid committing real tokens; use mocks or environment variables.",
			VulnPOC:     "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdGF0dXMiOiJzdWNjZXNzIiwiZGF0YSI6eyJpZCI6MX19",
			Severity:    "medium",
			Confidence:  "Firm",
			AssetType:   "repo",
			AssetValue:  "./test/api/userApiSpec.ts",
			Tags:        []string{"jwt", "hardcoded-token", "kingfisher"},
			RawVulnJSON: `{"ruleId":"JSON Web Token (base64url-encoded)","level":"warning","message":{"text":"Rule JSON Web Token (base64url-encoded) matched ./test/api/userApiSpec.ts"},"locations":[{"physicalLocation":{"artifactLocation":{"uri":"./test/api/userApiSpec.ts"},"region":{"startLine":302}}}]}`,
			LastSeenAt:  oneHourAgo,
			CreatedAt:   fiveDaysAgo,
			UpdatedAt:   oneHourAgo,
		},
		{
			...
			VulnInfo:    "JSON Web Token (base64url-encoded)",
			VulnTitle:   "JSON Web Token (base64url-encoded)",
			VulnDesc:    "Hard-coded JWT token found in Cypress E2E test for forged JWT testing scenario.",
			VulnPOC:     "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJkYXRhIjp7ImVtYWlsIjoicnNhX2xvcmRAanVpY2Utc2gub3AifX0",
			Severity:    "medium",
			Confidence:  "Firm",
			AssetType:   "repo",
			AssetValue:  "./test/cypress/e2e/forgedJwt.spec.ts",
			Tags:        []string{"jwt", "hardcoded-token", "kingfisher"},
			RawVulnJSON: `{"ruleId":"JSON Web Token (base64url-encoded)","level":"warning","message":{"text":"Rule JSON Web Token (base64url-encoded) matched ./test/cypress/e2e/forgedJwt.spec.ts"},"locations":[{"physicalLocation":{"artifactLocation":{"uri":"./test/cypress/e2e/forgedJwt.spec.ts"},"region":{"startLine":22}}}]}`,
			LastSeenAt:  oneHourAgo,
			CreatedAt:   fiveDaysAgo,
			UpdatedAt:   oneHourAgo,
		},
