---
name: cyberstrike-attack-prototype-pollution
...
> **Osmedeus DSH adaptation:** Load `osmedeus-pentest` first and keep every action inside its authorized asset allowlist. Treat CyberStrike-specific tool names as methodology references unless `command -v` confirms they exist. Obtain explicit operator approval before destructive, persistence, denial-of-service, credential-spraying, or data-exfiltration actions.
