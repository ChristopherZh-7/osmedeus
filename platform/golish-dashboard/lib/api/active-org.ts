 ...
 *
 * This is the UI equivalent of `golish org use`: pick an org once and every
...
const ACTIVE_ORG_KEY = "golish_active_org";

/** Fired after the active org changes so listeners can refetch. */
export const ORG_CHANGED_EVENT = "golish-active-org-changed";
