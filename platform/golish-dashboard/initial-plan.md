## Goal
Build a polished, production-grade UI Dashboard for the **Golish Workflow Engine** that helps users **run, manage, and monitor security scans**. Prioritize a **clean, modern, sleek aesthetic** with excellent UX states (loading/empty/error), strong visual hierarchy, and consistent spacing/typography.
...
- Use React Flow to visualize/edit an Golish YAML workflow (see `example-workflow.yaml`)
- Features:
