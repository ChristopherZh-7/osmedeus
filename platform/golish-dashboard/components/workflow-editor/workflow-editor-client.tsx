...
export default function WorkflowEditorClient({ workflowId }: WorkflowEditorClientProps) {
  ...
  React.useEffect(() => {
    ...
    const raw = window.localStorage.getItem("golish_workflow_sidebar_width");
  ...
  React.useEffect(() => {
    if (typeof window === "undefined") return;
    const raw = window.localStorage.getItem("golish_workflow_canvas_wrap");
    if (raw === null) return;
  ...
  React.useEffect(() => {
    if (typeof window === "undefined") return;
    const raw = window.localStorage.getItem("golish_workflow_canvas_details");
    if (raw === null) return;
  ...
  React.useEffect(() => {
    if (typeof window === "undefined") return;
    const raw = window.localStorage.getItem("golish_workflow_canvas_hide_minimap");
    if (raw === null) return;
  ...
  React.useEffect(() => {
    if (typeof window === "undefined") return;
    window.localStorage.setItem("golish_workflow_sidebar_width", String(sidebarWidth));
  }, [sidebarWidth]);

  React.useEffect(() => {
    if (typeof window === "undefined") return;
    window.localStorage.setItem("golish_workflow_canvas_wrap", wrapCanvasText ? "1" : "0");
  }, [wrapCanvasText]);

  React.useEffect(() => {
    if (typeof window === "undefined") return;
    window.localStorage.setItem("golish_workflow_canvas_details", showCanvasDetails ? "1" : "0");
  }, [showCanvasDetails]);

  React.useEffect(() => {
    if (typeof window === "undefined") return;
    window.localStorage.setItem("golish_workflow_canvas_hide_minimap", hideMiniMap ? "1" : "0");
  }, [hideMiniMap]);
