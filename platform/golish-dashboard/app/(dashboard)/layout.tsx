...
export default function DashboardLayout({
  ...
  const handleSidebarOpenChange = React.useCallback((open: boolean) => {
    ...
    if (typeof window !== "undefined") {
      window.localStorage.setItem("golish_sidebar_open", String(open));
    }
  }, []);
  ...
  React.useEffect(() => {
    ...
    const savedOpen = window.localStorage.getItem("golish_sidebar_open");
    if (savedOpen !== null) {
      setSidebarOpen(savedOpen === "true");
      return;
    }
    const collapsedByDefault =
      window.localStorage.getItem("golish_sidebar_collapsed_by_default") === "true";
  ...
  React.useEffect(() => {
    ...
    window.addEventListener("golish-sidebar-collapsed-by-default-changed", handler);
    return () => {
      window.removeEventListener("golish-sidebar-collapsed-by-default-changed", handler);
    };
