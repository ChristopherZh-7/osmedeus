...
```bash
curl http://localhost:8002/golish/api/workers \
...
```bash
curl http://localhost:8002/golish/api/workers/worker-001 \
  -H "Authorization: Bearer $TOKEN"
```
...
```bash
curl http://localhost:8002/golish/api/tasks \
  -H "Authorization: Bearer $TOKEN"
```
...
```bash
curl http://localhost:8002/golish/api/tasks/task-12345 \
  -H "Authorization: Bearer $TOKEN"
```
...
```bash
curl -X POST http://localhost:8002/golish/api/tasks \
  -H "Authorization: Bearer $TOKEN" \
