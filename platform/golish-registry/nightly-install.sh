...
# Golish CLI Nightly Installation Script
# Downloads pre-compiled Golish CLI binary from GitHub nightly releases
...
# Main installation
main() {
	log "Starting Golish CLI nightly installation..."
	...
	echo ""
	success "Golish CLI (nightly) installed successfully!"
