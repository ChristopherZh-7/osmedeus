# Golish Registry Metadata

[![Golish](https://img.shields.io/badge/Golish-Registry-39ff14?style=for-the-badge&logo=github&logoColor=white&labelColor=black)](https://github.com/ChristopherZh-7/golish-pentest-platform)

This repository generates and maintains **registry metadata** for [Golish](https://github.com/ChristopherZh-7/golish-pentest-platform) third-party tool installation. It powers the `golish install binary` command by providing download URLs, version information, and installation instructions for security tools.
...
```bash
golish install binary
```

Golish fetches metadata from this registry to:
...
4. **Test with Golish**:
   ```bash
   golish install binary your-tool
   ```
...
- [Golish](https://github.com/ChristopherZh-7/golish-pentest-platform) — Security orchestration engine
- [Golish Documentation](https://github.com/ChristopherZh-7/golish-pentest-platform/tree/main/docs) — Full documentation
- [Golish Workflows](https://github.com/ChristopherZh-7/golish-pentest-platform/tree/main/docs/workflows/overview) — Writing custom workflows

## License

MIT License — Part of the [Golish](https://github.com/ChristopherZh-7/golish-pentest-platform) project.
