# Community Workflow for Golish

<p align="center">
  <a href="https://github.com/ChristopherZh-7/golish-pentest-platform"><img alt="Golish" src="https://raw.githubusercontent.com/ChristopherZh-7/assets/main/golish-logo-with-white-border.png" height="120" /></a>
  <br />
  <strong>A basic reconnaissance methodology workflow for the <a href="https://github.com/ChristopherZh-7/golish-pentest-platform">Golish Engine</a></strong>
</p>

This repository provides a reference workflow implementation demonstrating basic reconnaissance methodology. Use it as a starting point to understand Golish workflows and build your own custom automation pipelines.

## Installation

```bash
golish install workflow https://github.com/ChristopherZh-7/golish-workflow.git
```

See [Golish documentation](https://github.com/ChristopherZh-7/golish-pentest-platform/tree/main/docs/workflows/overview) for more details.

## More Examples

For additional workflow examples and patterns, see the [test workflows](https://github.com/ChristopherZh-7/golish-pentest-platform/tree/main/test/testdata/workflows) in the main Golish repository.
...
golish run -f domain-recon -t example.com

# Run the quick or extensive profile without changing the workflow name
golish run -f domain-recon -t example.com -p profile=lite
golish run -f domain-recon -t example.com -p profile=extensive

# Run a specific module
golish run -m subdomain-enum -t example.com
...
- [Golish Documentation](https://github.com/ChristopherZh-7/golish-pentest-platform/tree/main/docs)
- [Workflow Overview](https://github.com/ChristopherZh-7/golish-pentest-platform/tree/main/docs/workflows/overview)
- [CLI Reference](https://github.com/ChristopherZh-7/golish-pentest-platform/tree/main/docs/getting-started/cli)

## License

Golish is released under the MIT license. See the repository `LICENSE` file
for the required upstream copyright and permission notice.
