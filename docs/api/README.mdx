---
title: "Golish API Documentation"
...
| [Companies](companies.md) | Confirm legal identity and authorized root-domain scope |
...
| [Agent Harness](agent-harness.mdx) | DeepSeek Harness sidecar connection status |
